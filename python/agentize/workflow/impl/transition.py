...
TRANSITIONS: TransitionTable = {
    ...
    (STAGE_REVIEW, EVENT_REVIEW_PASS): STAGE_SIMP,
    (STAGE_REVIEW, EVENT_REVIEW_FAIL): STAGE_IMPL,
    (STAGE_REVIEW, EVENT_FATAL): STAGE_FATAL,
    (STAGE_SIMP, EVENT_SIMP_PASS): STAGE_PR,
    (STAGE_SIMP, EVENT_SIMP_FAIL): STAGE_IMPL,
    (STAGE_SIMP, EVENT_FATAL): STAGE_FATAL,
...
def validate_transition_table(table: TransitionTable | None = None) -> None:
    ...
    required_pairs: tuple[TransitionKey, ...] = (
        ...
        (STAGE_SIMP, EVENT_SIMP_PASS),
        (STAGE_SIMP, EVENT_SIMP_FAIL),
